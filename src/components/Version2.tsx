...
function Version2() {
  return (
    <div className="v2-body">
      <div className="v2-whiteboard">
        <div className="v2-sticky-note">
          <h3>🎯 Ziele</h3>
          <ul>
        ...
        <div className="v2-header">
          ...
          <p className="v2-date">Meeting Notizen | November 2025</p>
        </div>

        <div className="v2-main-structure">
          <div className="v2-section-box v2-home">
            <div className="v2-section-icon">🏠</div>
            <h2>1. Startseite</h2>
            <ul>
              <li>Hero-Section</li>
          ...
          <div className="v2-section-box v2-solutions">
            <div className="v2-section-icon">🔧</div>
            <h2>2. Lösungen</h2>
            <ul>
          ...
          <div className="v2-section-box v2-company">
            <div className="v2-section-icon">🏢</div>
            <h2>3. Unternehmen</h2>
            <ul>
          ...
          <div className="v2-section-box v2-career">
            <div className="v2-section-icon">👔</div>
            <h2>4. Karriere</h2>
            <ul>
          ...
          <div className="v2-section-box v2-service">
            <div className="v2-section-icon">🛠️</div>
            <h2>5. Service</h2>
            <ul>
          ...
          <div className="v2-section-box v2-contact">
            <div className="v2-section-icon">📞</div>
            <h2>6. Kontakt</h2>
            <ul>
              <li>Formular</li>
        ...
        <div className="v2-process-section">
          ...
          <div className="v2-process-steps">
            ...
            <div className="v2-step">
              ...
              <div className="v2-step-icon">✏️</div>
              <h3>Konstruktion</h3>
            ...
            <div className="v2-step">
              <div className="v2-step-number">4</div>
              <div className="v2-step-icon">🔧</div>
              <h3>Montage</h3>
            ...
            <div className="v2-step">
              <div className="v2-step-number">5</div>
              <div className="v2-step-icon">🛡️</div>
              <h3>Service</h3>
              <p>Wartung & Support</p>
            </div>
        ...
        <div className="v2-tech-section">
          ...
          <div className="v2-tech-badges">
            <div className="v2-badge">📄 Filteranlagen</div>
            <div className="v2-badge">🌀 Ventilatoren</div>
            <div className="v2-badge">🔩 Rohrteile</div>
            <div className="v2-badge">📊 Datenblätter</div>
          </div>
        </div>

        <div className="v2-footer-notes">
          <div className="v2-note-card">
